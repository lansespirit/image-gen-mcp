...
class PromptTemplateResourceManager:
    ...
    def list_templates(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "usage": {
                "description": "Use prompt-templates://{template_id} to get detailed information about specific templates",
    ...
    def get_template_details(self, template_id: str) -> Dict[str, Any] | None:
        ...
        if details:
            ...
            details["usage"] = {
                ...
                "parameter_format": "Pass parameters as specified in the parameters list",
                "example_calls": self._generate_example_calls(template_id, details["parameters"])
            }
    ...
    def get_template_not_found_response(self, template_id: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "usage": {
                "description": "Use prompt-templates://list to see all available templates",
                "example": "prompt-templates://creative_image"
            }
        }
    
    def _generate_example_calls(self, template_id: str, parameters: list) -> list[str]:
        ...
        for i, param in enumerate(parameters[:3]):
            if param.get("required") or i < 2:
                value = param.get("examples", [param.get("default", "value")])[0] if param.get("examples") else param.get("default", "value")
